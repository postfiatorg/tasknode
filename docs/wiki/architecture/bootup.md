...
### Memory Efficiency
- [ ] Boot checks use bounded smoke tests and health endpoints.
- [ ] Startup docs do not imply full chain replay or full runtime-store scans.

### Code Quality
- [ ] Commands resolve in `package.json`.
- [ ] Ports and URLs match Docker, Vite, and Fly configuration.

### Coherence
- [ ] Deployment details link to the Deployment page instead of duplicating every path.
- [ ] Worker health links to System Status and worker architecture pages.

### Bloat
- [ ] Page stays focused on starting and first triage.
- [ ] Deep architecture remains on specific architecture pages.

### Security
- [ ] No secret values, seeds, private keys, or tokens appear in this page.
- [ ] Wallet seed handling describes browser-local custody only.

...
| `gpt-5.5-pro` | Focused smoke expectation — `FIXTURE-ONLY` | `scripts/hive-project-planning-smoke.mjs:76` (live Project carrier contract; Board Manager Pro contract removed) |
| `gpt-5.5-pro-2026-04-23` | Focused dated-model expectation — `FIXTURE-ONLY` | `scripts/hive-project-planning-smoke.mjs:40,83` (live Project carrier contract; Board Manager Pro contract removed) |
...
| `gpt-5.5-pro` active default/display | Board Manager fallback removed. Secretary/Project live defaults and system-status pricing remain unchanged; those live/historical references are not change targets. | `server/hive-project-worker.js:27`; `server/hive-secretary-worker.js:45`; `server/system-status.js:39` |

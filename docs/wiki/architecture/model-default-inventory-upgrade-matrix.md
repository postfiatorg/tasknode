...
| Hive Secretary | OpenAI Responses | `gpt-5.5-pro`; `high` | Recommend `gpt-5.6-sol` with `reasoning.mode: "pro"` and explicit `reasoning.effort: "high"`; do not implement | `RECOMMEND-ONLY` | The successor mapping changes request shape and autonomous-worker cost behavior. [OpenAI GPT-5.6 reasoning documentation](https://developers.openai.com/api/docs/guides/reasoning) | unknown/not comparable | `server/hive-secretary-worker.js:44-50` |
| Hive Project | OpenAI Responses | `gpt-5.5-pro`; `high` | Recommend `gpt-5.6-sol` with `reasoning.mode: "pro"` and explicit `reasoning.effort: "high"`; do not implement | `RECOMMEND-ONLY` | The successor mapping changes request shape and autonomous-worker cost behavior. [OpenAI GPT-5.6 reasoning documentation](https://developers.openai.com/api/docs/guides/reasoning) | unknown/not comparable | `server/hive-project-worker.js:26-39` |

...
Status: deprecated implemented milestone. Current product truth lives in `Surfaces -> Hive`, `Architecture -> AI Providers`, and `Architecture -> Board Manager Secretary Packet`.

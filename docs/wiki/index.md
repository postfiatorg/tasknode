...
| Orc operators, Nazgul oversight, shared review state, triage labels, evidence rules, and guardrails | [Orc Operator Runtime](#docs/orc-operator-runtime), [Orc Army And On-Chain Agent Overview](#docs/orc-army-overview), [Agents](#docs/agents) |

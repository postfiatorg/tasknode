> Historical documentation snapshot, preserved September 5, 2026.
> This describes earlier implementations and proposals; use the current wiki for runtime authority.

...
export function buildNetworkTaskRequestContext({ source = {}, job = {}, reward = { min: 10000, max: 50000 } } = {}) {
  ...
  return {
    ...
    task_manager: safeObject(sourceObject.taskManager || sourceObject.task_manager),
    board_packet: safeObject(sourceObject.boardPacket || sourceObject.board_packet),
    operator_packet: safeObject(sourceObject.operatorPacket || sourceObject.operator_packet),

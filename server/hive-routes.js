    ...
    try {
      ...
      chatTurn = await appendChatTurn({
        ...
        assistantMetadata: {
          ...
          hiveReportsContextDigest: immediate.hiveReportsContextDigest,
          hiveReportsContextReportIds: immediate.hiveReportsContextReportIds,
          hiveReportsContextReportTypes: immediate.hiveReportsContextReportTypes,
          hiveHarvestReportId: immediate.hiveHarvestReportId,
          hiveLiveTaskPacketGeneratedAt: immediate.hiveLiveTaskPacketGeneratedAt,
          promptPath: immediate.promptPath,
          promptDigest: immediate.promptDigest,
        },
        runMetadata: {
          kind: "hive_immediate_response",
          hiveContextEntryId: entry.id,

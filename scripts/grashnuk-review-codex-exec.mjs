...
function buildPrompt({ target } = {}) {
  return [
    ...
    "- Do not perform broad refactors, style churn, or documentation-only criticism unless it prevents operator misuse.",
    "",
    ...
    "5. Commit fixes as a new commit with a clear message. Push/deploy only when the fix requires it.",
    "6. Return JSON matching schemas/grashnuk-review-codex-result.schema.json.",
    "",
    "Final JSON guidance:",

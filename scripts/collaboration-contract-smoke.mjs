...
assert.match(repository, /identity: identityDocument\(accountId\)/);
...
const appShell = await readFile(new URL("../src/main.jsx", import.meta.url), "utf8");
...
const runtime = await readFile(new URL("../server/index.js", import.meta.url), "utf8");
...
const appStyles = await readFile(new URL("../src/styles.css", import.meta.url), "utf8");

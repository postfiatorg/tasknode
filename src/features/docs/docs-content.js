...
const PROMPT_SOURCES = [
  ...
  },
  {
    ...
    summary: "Turns private Task Node activity and requested visual style into a non-identifying, enum-backed persona, action, palette, setting, material, and art-direction brief through Ambient GLM 5.2.",
  ...
  },
  {
    ...
    summary: "Reviews and sanitizes the art brief without flattening safe visual direction before the isolated OpenAI image renderer receives it.",
